...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: Once var rando was changed to let rando it only existed within the scope of the while loop and could not be used or called anywhere else in the function.
  console.log(viewed);
